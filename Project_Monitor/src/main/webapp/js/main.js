...
const cardChart1 = new Chart(document.getElementById('card-chart1'), {
  ...
  data: {
    ...
    datasets: [{
      ...
      data: [65, 59, 84, 84, 51, 55, 40,86,32]
    }]
  },
  options: {
    plugins: {
...
const mainChart3 = new Chart(document.getElementById('main-chart3'), {
    type: 'line',
    data: {
        labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July'],
        datasets: [{
...
const mainChart4 = new Chart(document.getElementById('main-chart4'), {
    type: 'line',
    data: {
        labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July'],
        datasets: [{
